...
-- ================================================
-- NOTE: Using existing notifications table with 'recipient_id' column
...
-- 3. Add indexes FIRST (before constraint)
...
-- 4. Create NEW constraint that includes ALL possible types
-- This includes both existing types AND new shipment types
ALTER TABLE notifications
ADD CONSTRAINT notifications_type_check CHECK (type IN (
    ...
    'WITHDRAWAL_APPROVED',
    'WITHDRAWAL_REJECTED',
    -- Legacy/existing types (add any found in your DB)
    'SYSTEM',
    'INFO',
    'WARNING',
    'ERROR',
